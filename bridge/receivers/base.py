...
class Incoming:
    ...
    name: str = ""
    # Сообщение пришло не из лички, а из группы или канала. Мост в уроке —
    # личный разговор: в группах он слушает, но не отвечает и в журнал стуков
    # их не пишет, иначе «кто стучался» превращается в список чужих чатов.
    group: bool = False
    raw: dict = field(default_factory=dict)
